...
size_t Editor::Factory::getPropertiesSize(ComponentType component){
...
std::vector<Editor::PropertyData> Editor::Factory::getProperties(ComponentType component, void* compRef){
