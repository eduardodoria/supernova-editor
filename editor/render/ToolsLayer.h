...
namespace Supernova::Editor{
    ...
    public:
        ...
        void updateGizmo(Camera* sceneCam, Vector3& position, Quaternion& rotation, float scale, Vector2 uiSize, float selectionOffset, OBB obb, Ray& mouseRay, bool mouseClicked);
