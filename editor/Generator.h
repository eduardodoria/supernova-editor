...
namespace Supernova::Editor {
    ...
    private:
        ...
        std::string getCopyShadersCMakeConfig(const std::string& targetName);
        std::string getCopyProjectAssetsCMakeConfig(const std::string& targetName);
        std::string getCopyTreeExcludingCMakeScript();
